...
FIXED_SE = False
OUT_DIR = "/mnt/raid/tbandyo/idp4vc_ws/SPECTRON_LOGS/VOICE_FILTER_DS_PRETRAINED_DPT_LR0_001_WD_1e5_DSPLIT_99_LR_SCHEDULE"
...
train_size = int(len(dataset) * 0.99)  # 99 percent of the loaded dataset will be used as training dataset
val_size = len(dataset) - train_size  # rest 1 percent will be used as validation set
...
sep_state = torch.load("models/DPTNet.pth")
sep_model.load_state_dict(sep_state["DPTNet"], strict=False)
...
if __name__ == "__main__":
    for e in range(MAX_EPOCHS):
        ...
        # LR schedule manually
        if e == 50:
            set_lr(optimizer, 0.0007)
        elif e == 100:
            set_lr(optimizer, 0.0004)
        elif e == 150:
